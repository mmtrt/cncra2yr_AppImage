...
mkdir -p temp AppDir/winedata AppDir/usr/share AppDir/bin ra2yr-mp/usr/share/icons ra2yr-mp/winedata/yr ; cp cncra2yr.desktop ra2yr-mp ; cp wrapper ra2yr-mp ; cp cncra2yr.png ra2yr-mp/usr/share/icons
...
( cd temp ; ./dotnet --appimage-extract ; cp -R AppDir/usr/share/dotnet ../AppDir/usr/share/ ; cd ../AppDir/usr/bin ; ln -s ../../usr/share/dotnet/dotnet . ) || true
...
mkdir -p temp AppDir/winedata AppDir/usr/share AppDir/bin ra2yr-mp/usr/share/icons ra2yr-mp/winedata ; cp cncra2yr.desktop ra2yr-mp ; cp wrapper ra2yr-mp ; cp cncra2yr.png ra2yr-mp/usr/share/icons
...
mkdir -p AppDir/winedata/yr ; cp -r "ra2yr-mp/"* AppDir ; tar -xf package*.tar.gz -C AppDir/winedata/yr ; rm package*.tar.gz ; rm -rf temp
